  ...
  def gradients(self, objective, parameters):
    ...
    for grad in grads:
      if isinstance(grad, tf.IndexedSlices):
        noise = self.noise_stdev * tf.random.normal(tf.shape(grad.values))
...
class Rosenbrock(Problem2D):
  ...
  def init_tensors(self, seed=None):
    """Returns a list of tensors with the given shape."""
    return [tf.random.uniform(shape, minval=-5., maxval=10., seed=seed)
            for shape in self.param_shapes]
...
class Ackley(Problem2D):
  ...
  def init_tensors(self, seed=None):
    """Returns a list of tensors with the given shape."""
    return [tf.random.uniform(shape, minval=-32.768, maxval=32.768, seed=seed)
            for shape in self.param_shapes]
...
class Beale(Problem2D):
  ...
  def init_tensors(self, seed=None):
    """Returns a list of tensors with the given shape."""
    return [tf.random.uniform(shape, minval=-4.5, maxval=4.5, seed=seed)
            for shape in self.param_shapes]
...
class StyblinskiTang(Problem2D):
  ...
  def init_tensors(self, seed=None):
    """Returns a list of tensors with the given shape."""
    return [tf.random.uniform(shape, minval=-5., maxval=5., seed=seed)
            for shape in self.param_shapes]
...
class Matyas(Problem2D):
  ...
  def init_tensors(self, seed=None):
    """Returns a list of tensors with the given shape."""
    return [tf.random.uniform(shape, minval=-10, maxval=10, seed=seed)
            for shape in self.param_shapes]
...
class Branin(Problem2D):
  ...
  def init_tensors(self, seed=None):
    """Returns a list of tensors with the given shape."""
    x1 = tf.random.uniform((1,), minval=-5., maxval=10.,
                           seed=seed)
    x2 = tf.random.uniform((1,), minval=0., maxval=15.,
                           seed=seed)
...
class Michalewicz(Problem2D):
  ...
  def init_tensors(self, seed=None):
    """Returns a list of tensors with the given shape."""
    return [tf.random.uniform(shape, minval=0., maxval=np.pi, seed=seed)
            for shape in self.param_shapes]
