...
python train.py problems/0/kwargs/batch_size=64 strategy/epochs_per_period=5 strategy/min_periods=20 "training/epochs=5 strategy/annealing_schedule='lambda i: 1. if i == 0 else 0.'"
