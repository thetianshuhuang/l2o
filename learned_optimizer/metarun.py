...
tf.compat.v1.app.flags.DEFINE_string("train_dir", "/tmp/lol/",
                           """Directory to store parameters and results.""")

tf.compat.v1.app.flags.DEFINE_integer("task", 0,
                            """Task id of the replica running the training.""")
tf.compat.v1.app.flags.DEFINE_integer("worker_tasks", 1,
                            """Number of tasks in the worker job.""")

tf.compat.v1.app.flags.DEFINE_integer("num_problems", 1000,
                            """Number of sub-problems to run.""")
tf.compat.v1.app.flags.DEFINE_integer("num_meta_iterations", 5,
                            """Number of meta-iterations to optimize.""")
tf.compat.v1.app.flags.DEFINE_integer("num_unroll_scale", 40,
                            """The scale parameter of the exponential
                            distribution from which the number of partial
                            unrolls is drawn""")
tf.compat.v1.app.flags.DEFINE_integer("min_num_unrolls", 1,
                            """The minimum number of unrolls per problem.""")
tf.compat.v1.app.flags.DEFINE_integer("num_partial_unroll_itr_scale", 200,
                            """The scale parameter of the exponential
                               distribution from which the number of iterations
                               per unroll is drawn.""")
tf.compat.v1.app.flags.DEFINE_integer("min_num_itr_partial_unroll", 50,
                            """The minimum number of iterations for one
                               unroll.""")

tf.compat.v1.app.flags.DEFINE_string("optimizer", "HierarchicalRNN",
                           """Which meta-optimizer to train.""")

# CoordinatewiseRNN-specific flags
tf.compat.v1.app.flags.DEFINE_integer("cell_size", 20,
                            """Size of the RNN hidden state in each layer.""")
tf.compat.v1.app.flags.DEFINE_integer("num_cells", 2,
                            """Number of RNN layers.""")
tf.compat.v1.app.flags.DEFINE_string("cell_cls", "GRUCell",
                           """Type of RNN cell to use.""")

# Metaoptimization parameters
tf.compat.v1.app.flags.DEFINE_float("meta_learning_rate", 1e-6,
                          """The learning rate for the meta-optimizer.""")
tf.compat.v1.app.flags.DEFINE_float("gradient_clip_level", 1e4,
                          """The level to clip gradients to.""")

# Training set selection
tf.compat.v1.app.flags.DEFINE_boolean("include_quadratic_problems", False,
                            """Include non-noisy quadratic problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_noisy_quadratic_problems", True,
                            """Include noisy quadratic problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_large_quadratic_problems", True,
                            """Include very large quadratic problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_bowl_problems", True,
                            """Include 2D bowl problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_softmax_2_class_problems", True,
                            """Include 2-class logistic regression problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_noisy_softmax_2_class_problems", True,
                            """Include noisy 2-class logistic regression
                               problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_optimization_test_problems", True,
                            """Include non-noisy versions of classic
                               optimization test problems, e.g. Rosenbrock.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_noisy_optimization_test_problems", True,
                            """Include gradient-noise versions of classic
                               optimization test problems, e.g. Rosenbrock""")
tf.compat.v1.app.flags.DEFINE_boolean("include_fully_connected_random_2_class_problems",
                            True, """Include MLP problems for 2 classes.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_matmul_problems", True,
                            """Include matrix multiplication problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_log_objective_problems", True,
                            """Include problems where the objective is the log
                               objective of another problem, e.g. Bowl.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_rescale_problems", True,
                            """Include problems where the parameters are scaled
                               version of the original parameters.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_norm_problems", True,
                            """Include problems where the objective is the
                               N-norm of another problem, e.g. Quadratic.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_sum_problems", True,
...
tf.compat.v1.app.flags.DEFINE_boolean("include_sparse_gradient_problems", True,
                            """Include problems where the gradient is set to 0
                               with some high probability.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_sparse_softmax_problems", False,
                            """Include sparse softmax problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_one_hot_sparse_softmax_problems", False,
                            """Include one-hot sparse softmax problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_noisy_bowl_problems", True,
                            """Include noisy bowl problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_noisy_norm_problems", True,
                            """Include noisy norm problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_noisy_sum_problems", True,
                            """Include noisy sum problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_sum_of_quadratics_problems", False,
                            """Include sum of quadratics problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_projection_quadratic_problems", False,
                            """Include projection quadratic problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_outward_snake_problems", False,
                            """Include outward snake problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_dependency_chain_problems", False,
                            """Include dependency chain problems.""")
tf.compat.v1.app.flags.DEFINE_boolean("include_min_max_well_problems", False,
                            """Include min-max well problems.""")

# Optimizer parameters: initialization and scale values
tf.compat.v1.app.flags.DEFINE_float("min_lr", 1e-6,
                          """The minimum initial learning rate.""")
tf.compat.v1.app.flags.DEFINE_float("max_lr", 1e-2,
                          """The maximum initial learning rate.""")

# Optimizer parameters: small features.
tf.compat.v1.app.flags.DEFINE_boolean("zero_init_lr_weights", True,
...
tf.compat.v1.app.flags.DEFINE_boolean("use_relative_lr", True,
                            """Whether to use the relative learning rate as an
                               input during training. Can only be used if
                               learnable_decay is also True.""")
tf.compat.v1.app.flags.DEFINE_boolean("use_extreme_indicator", False,
...
tf.compat.v1.app.flags.DEFINE_boolean("use_log_means_squared", True,
                            """Whether to track the log of the mean squared
                               grads instead of the means squared grads.""")
tf.compat.v1.app.flags.DEFINE_boolean("use_problem_lr_mean", True,
...
tf.compat.v1.app.flags.DEFINE_boolean("learnable_decay", True,
                            """Whether to learn weights that dynamically
                              modulate the input scale via RMS decay.""")
tf.compat.v1.app.flags.DEFINE_boolean("dynamic_output_scale", True,
                            """Whether to learn weights that dynamically
                               modulate the output scale.""")
tf.compat.v1.app.flags.DEFINE_boolean("use_log_objective", True,
                            """Whether to use the log of the scaled objective
                               rather than just the scaled obj for training.""")
tf.compat.v1.app.flags.DEFINE_boolean("use_attention", False,
                            """Whether to learn where to attend.""")
tf.compat.v1.app.flags.DEFINE_boolean("use_second_derivatives", True,
                            """Whether to use second derivatives.""")
tf.compat.v1.app.flags.DEFINE_integer("num_gradient_scales", 4,
                            """How many different timescales to keep for
                               gradient history. If > 1, also learns a scale
                               factor for gradient history.""")
tf.compat.v1.app.flags.DEFINE_float("max_log_lr", 33,
                          """The maximum log learning rate allowed.""")
tf.compat.v1.app.flags.DEFINE_float("objective_training_max_multiplier", -1,
...
tf.compat.v1.app.flags.DEFINE_boolean("use_gradient_shortcut", True,
...
tf.compat.v1.app.flags.DEFINE_boolean("use_lr_shortcut", False,
                            """Whether to add the difference between the current
                               learning rate and the desired learning rate to
                               the RNN input.""")
tf.compat.v1.app.flags.DEFINE_boolean("use_grad_products", True,
                            """Whether to use gradient products in the input to
                               the RNN. Only applicable when num_gradient_scales
                               > 1.""")
tf.compat.v1.app.flags.DEFINE_boolean("use_multiple_scale_decays", False,
                            """Whether to use many-timescale scale decays.""")
tf.compat.v1.app.flags.DEFINE_boolean("use_numerator_epsilon", False,
                            """Whether to use epsilon in the numerator of the
                               log objective.""")
tf.compat.v1.app.flags.DEFINE_boolean("learnable_inp_decay", True,
                            """Whether to learn input decay weight and bias.""")
tf.compat.v1.app.flags.DEFINE_boolean("learnable_rnn_init", True,
...
def main(unused_argv):
  ...
  def num_unrolls():
    return (
      np.random.geometric(p=FLAGS.num_unroll_scale) + FLAGS.min_num_unrolls)

  def num_partial_unroll_itrs():
    return (
      np.random.geometric(p=FLAGS.num_partial_unroll_itr_scale) +
